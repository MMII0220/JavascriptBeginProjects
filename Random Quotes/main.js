...
//   };
//   let previousQuote = null; // previous quote
//   const btnQuotesShow = document.querySelector('.btn-info');

//   btnQuotesShow.addEventListener('click', () => {
//     displayRandomQuotes(quotes, previousQuote);
//   });

//   const displayRandomQuotes = (quotes, previousQuote) => {  // func
